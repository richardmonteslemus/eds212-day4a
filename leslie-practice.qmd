...
# If there arent enough spots it'll stop once it reaches your goal. If theres more spots than given it'll restart. 
```
## Matrix math 
```{r}
4 * my_matrix
...
Find population for each life stage at T = 1 
```{r}
...
Find population for each lifestage  at year 1 
```{r}
